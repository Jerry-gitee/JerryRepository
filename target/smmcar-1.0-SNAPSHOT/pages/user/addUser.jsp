                    ...
                    <form method="post" id="myform" name="myform" >
                        <table class="insert-tab" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="nameByAdmin" name="userName" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    <input class="common-text required"  id="pwdByAdmin" name="userPassword" size="50"  type="text">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="telByAdmin" name="tel" size="50"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
