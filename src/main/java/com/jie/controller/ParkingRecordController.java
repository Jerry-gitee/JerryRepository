...
import com.jie.utils.EasyPoiUtil;
...
public class ParkingRecordController {
    ...
    public String toAdminLookParkRecordPage(String userId, String car_number, Integer pageNo, Model model,
                                            HttpSession session) {
        ...
        page.setUrl("parkingRecord/toParkRecordPage?userId=" + userId + "&car_number=" + car_number);//此处null值经过jsp
        // 页面变为“null”
        //设置到请求域中
    ...
    @ResponseBody
    public void exportParkingRecord(HttpSession session,HttpServletResponse response) throws IOException {
        Integer userid = null;
        User sUser = (User) session.getAttribute("sUser");
        if (sUser != null) {
            userid = sUser.getId();
        }
        parkingRecordService.getParkingRecordByUserid(userid,response);
    }
